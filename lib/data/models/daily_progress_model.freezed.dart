...
mixin _$QuizStateModel {
  ...
  $QuizStateModelCopyWith<QuizStateModel> get copyWith =>
      _$QuizStateModelCopyWithImpl<QuizStateModel>(
          this as QuizStateModel, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is QuizStateModel &&
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, selectedAnswer, showResult, isCorrect, earnedPoints);

  @override
  String toString() {
    return 'QuizStateModel(selectedAnswer: $selectedAnswer, showResult: $showResult, isCorrect: $isCorrect, earnedPoints: $earnedPoints)';
  }
}

/// @nodoc
abstract mixin class $QuizStateModelCopyWith<$Res> {
  factory $QuizStateModelCopyWith(
          QuizStateModel value, $Res Function(QuizStateModel) _then) =
      _$QuizStateModelCopyWithImpl;
  @useResult
  $Res call(
      {int? selectedAnswer,
      bool showResult,
...
/// @nodoc
class _$QuizStateModelCopyWithImpl<$Res>
    implements $QuizStateModelCopyWith<$Res> {
  _$QuizStateModelCopyWithImpl(this._self, this._then);

  final QuizStateModel _self;
  final $Res Function(QuizStateModel) _then;
...
@jsonSerializable
class _QuizStateModel implements QuizStateModel {
  const _QuizStateModel(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$QuizStateModelCopyWith<_QuizStateModel> get copyWith =>
      __$QuizStateModelCopyWithImpl<_QuizStateModel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _QuizStateModel &&
            (identical(other.selectedAnswer, selectedAnswer) ||
                other.selectedAnswer == selectedAnswer) &&
            (identical(other.showResult, showResult) ||
                other.showResult == showResult) &&
...
/// @nodoc
abstract mixin class _$QuizStateModelCopyWith<$Res>
    implements $QuizStateModelCopyWith<$Res> {
  factory _$QuizStateModelCopyWith(
          _QuizStateModel value, $Res Function(_QuizStateModel) _then) =
      __$QuizStateModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int? selectedAnswer,
...
/// @nodoc
class __$QuizStateModelCopyWithImpl<$Res>
    implements _$QuizStateModelCopyWith<$Res> {
  __$QuizStateModelCopyWithImpl(this._self, this._then);

  final _QuizStateModel _self;
  final $Res Function(_QuizStateModel) _then;
